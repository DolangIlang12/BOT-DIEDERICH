...
//=================================================//
CFonts.say("SC DIEDERICH BY ARFUR117", {
   font: 'chrome',
  align: 'left',
...
//await sleep(400)  
console.log(color(`─[`,`magenta`),`「`,  color(`ArFur117`,`red`), `」`,  color(`]─`,`magenta`))
//await sleep(400)  
start(`1`,`Connecting...`)
} else if (connection === "open") {
  oka.sendMessage('6283129627886' + "@s.whatsapp.net", { text: `*halo Argo*
  Telah Terhubung!!
  
  *_Jangan Lupa Untuk Masuk GC Argo Untuk Mendapatkan Info Terbaru.*
  
  *https://www.tiktok.com/@arfur117.*` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
