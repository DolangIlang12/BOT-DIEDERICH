...
sourceUrl: `https://wa.me/6283129627886`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Diederich`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ArFur,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }}}}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yoapk ArFur117*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yozip ArFur117*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yopdf ArFur117*')
}
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
「 *BOT INFO* 」
⭔Nama Creator : *Argo Northop*
⭔Nomor Creator : *@${owned.split("@")[0]}*
⭔Nama Script : *Diederich*
⭔Versi Script : *2.0*
⭔Botz Name : *Diederich Olsen*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
*_Social Media_*
*TikTok : ▣https://www.tiktok.com/@arfur117*
...
"Name = Diederich Olsenディーデリク・オルセンAliases = Diderich, Derich, デリクMeasurements = Height: 192cm, Weight: 101kg
...
Aku adalah diederich olsen dan aku akan memerankan karakter ini, balas pesan sesuai sifat karakter ini dan perankan karakter ini secara mendalam (balas dengan bahasa gaul (bales pake lu dan gua), ceria(asik diajak bicara), seperti manusia, jangan baku & formal)` }, { role: 'user', content: text }]
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283129627886`)
...
"inviteExpiration": `MY NAME Diederich${buttonkal}`,
"groupName": `MY NAME Diederich${buttonkal}`,
"caption": `${buttonkal}`,
...
await loading()
m.reply(`¥ *Price Sewa Bot Diederich* €
...
if (args[0].startsWith(`+6283129627886`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ArFur117`);
});
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6283129627886',
title: `Diederich`,
sourceUrl: `https://wa.me/6283129627886`, 
thumbnail: thumb
}
...
//=================================================
case "listpanel": {
const text12 = `SEWA PANEL ArFur117 ⚡
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Argo, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Argo, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Argo, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
fs.unlinkSync(delb)
reply(`Diederich Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`Diederich Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf Argo + sambil reply pesan target* \n\n Contoh 2 : yopdf Argo`
m.reply(teksoooo)
}
break
//=================================================//
...
m.reply(`Diederich Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Diederich Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`Diederich Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip Argo + sambil reply pesan target* \n\n Contoh 2 : yozip Argo`
m.reply(teksooooo)
}
break
//=================================================//
...
m.reply(`Diederich Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Diederich Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`Diederich Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk Argo + sambil reply pesan target* \n\n Contoh 2 : yoapk Argo`
m.reply(teksoooooo)
}
break
//=================================================//
...
m.reply(`Diederich Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`Diederich Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`Diederich Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`Diederich Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
${teks}
•-------------------------------------------------•
*Pricelist Harga ArFur117 Panel* :
...
m.reply(`*Diederich Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
...
case 'jadibug': {
if (!isCreator) return m.reply('*khusus Premium*')
if (!text) throw `Contoh : ${prefix + command} BOT Derich`
let teks = `${text}`
{
