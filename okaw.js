...
global.pulsa = '-'
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Argo Northop' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['6283129627886'] // ubah aja pake nomor lu
global.premium = ['6283129627886']
//==========================BY Hw Mods=======================//
global.lolkey = 'a8e86232771f9bc1826742c1'
global.zenz = 'zenzkey_41b4fe7a5d' // https://api.zahwazein.xyz
global.keyopenai = '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'
//====================BY Hw Mods=============================//
global.botname = 'Diederich Olsen' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = 'Diederich' // ubah aja ini nama sticker
global.ta = '•' //cuma simbol
global.author = 'Arfur117' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
